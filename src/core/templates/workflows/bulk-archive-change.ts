...
6. **Show consolidated status table**
   ...
   | add-review-skill    | 1 left    | 2/5   | None    | None      | Warn   |
   \`\`\`
   ...
   * Conflict resolution:
   ...
   \`\`\`
   Warnings:
   - add-review-skill: 1 incomplete artifact, 3 incomplete tasks
   \`\`\`
...
9. **Display summary**
   ...
   Skipped 1 change:
   - add-review-skill (user chose not to archive incomplete)
